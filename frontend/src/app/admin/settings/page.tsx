...
export default function AdminSettingsPage() {
 ...
 { label: 'Email Address', value: user?.email || 'admin@campuslearn.com' },
 { label: 'Admin ID', value: user?._id || 'A2026-001' },
 ]
 },
 {
 ...
 <p className="text-sm mt-0.5 text-zinc-500">Manage your administrative account and system preferences</p>
 </div>
 </div>

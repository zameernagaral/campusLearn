...
export default function AdminTimetablePage() {
  ...
  useEffect(() => {
    // Simulate initial loading to show the skeleton loader
 ...
 { id: 6, subject: 'Artificial Intelligence', time: '10:00 AM - 11:00 AM', type: 'Lecture', faculty: 'Dr. Vihaan Reddy', batch: 'CS-A', room: 'Room 305', status: 'Upcoming', day: 'Wednesday', attendance: 0 },
  ...
  <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div className="bg-[#0f1115] p-6 rounded-2xl w-full max-w-md border border-zinc-800 shadow-2xl relative">
      ...
      <div className="space-y-4 mt-4">
        <p className="text-sm text-zinc-400">Upload the global campus timetable in CSV or Excel format. Our AI will automatically parse, detect conflicts, and sync it to all department schedules.</p>
  ...
  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
    <div>
      <h1 className="text-2xl font-black text-white">Campus Timetable</h1>
      <p className="text-zinc-400 mt-1 text-sm">Monitor all ongoing and upcoming classes across the entire campus</p>
    </div>
  ...
  <div className="card p-10 text-center text-muted">No classes scheduled for the campus on {activeDay}.</div>
  ) : (

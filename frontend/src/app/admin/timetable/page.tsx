...
export default function AdminTimetablePage() {
 ...
 <h2 className="text-xl font-bold mb-4 flex items-center gap-2"><Upload size={20} className="text-primary"/> Upload Global Timetable</h2>
 <div className="space-y-4">
 <p className="text-sm text-muted">Upload the global campus timetable in CSV or Excel format. Our AI will automatically parse, detect conflicts, and sync it to all department schedules.</p>
 ...
 setFile(null);
 toast.success('Global timetable uploaded and synced across campus!');
 }} 
 ...
 <div>
 <h1 className="text-2xl font-bold text-foreground">Campus Timetable</h1>
 <p className="text-muted mt-1">Monitor all ongoing and upcoming classes across the entire campus</p>
 </div>
 <div className="flex items-center gap-3">
 <button onClick={() => toast('Filters coming soon')} className="btn btn-ghost flex items-center gap-2">

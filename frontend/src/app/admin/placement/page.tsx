  ...
  return (
    <DashboardLayout requiredRole="admin">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Global Placement Overview</h1>
          <p className="text-muted mt-1">Monitor campus-wide placement scores and company readiness</p>
        </div>
      ...
      <div className="grid lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="card p-6 border-t-4 border-pink-500">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-muted font-medium">Avg Campus Score</p>

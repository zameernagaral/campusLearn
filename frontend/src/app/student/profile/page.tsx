...
export default function ProfilePage() {
 ...
 <button disabled title="Only Admins can edit profiles" style={{ opacity: 0.5, cursor: "not-allowed" }} className="w-full py-3 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors">
 <Edit2 size={16} /> Only Admin Can Edit Profile
 </button>
 </div>
 </div>

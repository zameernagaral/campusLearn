            ...
            >
              ...
              <div className="space-y-2 mb-6 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-zinc-900 dark:text-white">{cert.issuedBy?.name || 'System'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-zinc-500">Date Earned</span>
                  <span className="font-medium text-zinc-900 dark:text-white">{formatDate(cert.issuedAt)}</span>
                </div>
                {cert.grade && (
                  <div className="flex justify-between items-center">
                    <span className="text-zinc-500">Grade</span>
                    <span className="px-2 py-0.5 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 font-bold rounded-md uppercase">
                      {cert.grade}
                    </span>
                  </div>
                )}
                <div className="flex justify-between items-center mt-2 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                  ...
                  <span className="font-mono text-xs text-zinc-400">{cert.certificateId}</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 mt-auto">
                <button 
                  ...
                  className="flex-1 py-2.5 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white font-medium rounded-xl flex items-center justify-center gap-2 transition-colors text-sm"
                >
                ...
                <button 
                  ...
                  className="w-10 h-10 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-500 hover:text-zinc-900 dark:hover:text-white rounded-xl flex items-center justify-center transition-colors"

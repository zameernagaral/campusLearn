...
const STARTER_PROMPTS = [
  { icon: '📚', text: 'Explain Big O notation with examples', label: 'Algorithms' },
  { icon: '🧮', text: 'What is the difference between supervised and unsupervised learning?', label: 'ML' },
  { icon: '🔐', text: 'Explain how JWT authentication works', label: 'Security' },
  { icon: '💡', text: 'Help me prepare for my database exam', label: 'DBMS' },
  { icon: '🌐', text: 'What are the differences between TCP and UDP?', label: 'Networks' },
  { icon: '⚡', text: 'Create a study plan for the next 2 weeks', label: 'Study Plan' },
];

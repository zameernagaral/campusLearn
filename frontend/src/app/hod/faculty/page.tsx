          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-zinc-50 dark:bg-zinc-900/50 border-b border-zinc-200 dark:border-zinc-800">
                <th className="px-6 py-4 text-xs font-black text-zinc-400 uppercase tracking-widest">Faculty Member</th>
                <th className="px-6 py-4 text-xs font-black text-zinc-400 uppercase tracking-widest">Email</th>
                <th className="px-6 py-4 text-xs font-black text-zinc-400 uppercase tracking-widest">Employee ID</th>
                <th className="px-6 py-4 text-xs font-black text-zinc-400 uppercase tracking-widest">Designation</th>

...
export default function CardFlip({
 ...
 "opacity-0",
 "shadow-[0_0_50px_rgba(249,115,22,0.5)]",
 ...
 transform: scale(2);
 opacity: 0;
 box-shadow: 0px 0px 50px rgba(249, 115, 22, 0.5);
 }
 50% {
 transform: translate(0px, -5px) scale(1);
 opacity: 1;
 box-shadow: 0px 8px 20px rgba(249, 115, 22, 0.5);
 }
 100% {
 transform: translate(0px, 5px) scale(0.1);
 opacity: 0;
 box-shadow: 0px 10px 20px rgba(249, 115, 22, 0);
 }
 }
 `}</style>
 </div>
